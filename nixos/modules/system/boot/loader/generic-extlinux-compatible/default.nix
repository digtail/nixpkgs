...
let
  ...
  builder = import ./extlinux-conf-builder.nix { inherit config lib pkgs; };
  # The builder exposed in populateCmd, which runs on the build architecture
  populateBuilder = import ./extlinux-conf-builder.nix { inherit config lib; pkgs = pkgs.buildPackages; };
in
{
  options = {
